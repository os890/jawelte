 ...
 */
package org.os890.jawelte.tests.contentdiff.scenario15;
...
class Scenario15Test {
    ...
    @Test
    void xmlMismatchReportsXPathAndLine() {
        String expected = "<order>\n"
                + "  <id>5</id>\n"
                + "</order>";
        String actual = "<order><id>6</id></order>";
        assertThatThrownBy(() ->
