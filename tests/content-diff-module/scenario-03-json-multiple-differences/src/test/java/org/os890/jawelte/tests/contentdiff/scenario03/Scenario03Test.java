 ...
 */
package org.os890.jawelte.tests.contentdiff.scenario03;
...
class Scenario03Test {
    ...
    @Test
    void threeMismatchesAllReported() {
        String expected = "{\"a\":1,\"b\":2,\"c\":3}";
        String actual = "{\"a\":10,\"b\":20,\"c\":30}";
        assertThatThrownBy(() ->
                ContentDiff.forJson(actual).expectedContent(expected).assertEquals())
                .isInstanceOf(AssertionError.class)
                .satisfies(failure -> assertThat(failure.getMessage())
                        .contains("JSON diff found 3 difference(s):")
