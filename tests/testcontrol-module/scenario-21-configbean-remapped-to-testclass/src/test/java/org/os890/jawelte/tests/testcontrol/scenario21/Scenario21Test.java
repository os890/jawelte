 ...
 */
package org.os890.jawelte.tests.testcontrol.scenario21;
...
/**
 * Scenario 21 — a {@code @ConfigBean}-annotated class is remapped
 * from the stereotype's contributed {@code @ApplicationScoped} to
 * {@code @TestClassScoped} by testcontrol-module's CDI Extension.
...
class Scenario21Test {
    ...
    void configBeanIsRemappedToTestClassScoped() {
        ...
        assertThat(bean.getScope())
                .as("Scope of the @ConfigBean class after the testcontrol remap")
