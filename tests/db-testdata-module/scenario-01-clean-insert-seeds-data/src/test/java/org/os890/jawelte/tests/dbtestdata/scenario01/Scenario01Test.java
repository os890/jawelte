 ...
 */
package org.os890.jawelte.tests.dbtestdata.scenario01;
...
class Scenario01Test {
    ...
    void openConnection() throws Exception {
        connection = DriverManager.getConnection(
                "jdbc:h2:mem:scenario01;MODE=LEGACY;DB_CLOSE_DELAY=-1", "sa", "");
    ...
    @Test
    void cleanInsertSeedsRowsFromDataset() throws Exception {
