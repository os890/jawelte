...
class Scenario44Test {
    ...
    void openConnection() throws Exception {
        connection = DriverManager.getConnection(
                "jdbc:h2:mem:scenario44;MODE=LEGACY;DB_CLOSE_DELAY=-1", "sa", "");
    ...
    @Test
    void formatTextCsvRoutesToTheTestScenarioCsvSeedEngine() throws Exception {
        String csvDataset = "1,Alice\n2,Bob";
        DbSeed.forConnection(connection)
                .datasetContent(csvDataset)
                .format("text/csv")
                .cleanInsert()
                .execute();
