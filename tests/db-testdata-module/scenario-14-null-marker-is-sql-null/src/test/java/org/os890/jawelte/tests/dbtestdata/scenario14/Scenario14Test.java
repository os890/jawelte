 ...
 */
package org.os890.jawelte.tests.dbtestdata.scenario14;
...
class Scenario14Test {
    ...
    void openConnection() throws Exception {
        connection = DriverManager.getConnection(
                "jdbc:h2:mem:scenario14;MODE=LEGACY;DB_CLOSE_DELAY=-1", "sa", "");
    ...
    @Test
    void uppercaseNullMarkerInExpectedMatchesSqlNullInDatabase() {
