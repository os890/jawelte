 ...
 */
package org.os890.jawelte.tests.dbtestdata.scenario04;
...
class Scenario04Test {
    ...
    void openConnection() throws Exception {
        connection = DriverManager.getConnection(
                "jdbc:h2:mem:scenario04;MODE=LEGACY;DB_CLOSE_DELAY=-1", "sa", "");
    ...
    @Test
    void insertModeAddsRowsWithoutTouchingExistingOnes() throws Exception {
