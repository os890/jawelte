 ...
 */
package org.os890.jawelte.tests.dbtestdata.scenario28;
...
class Scenario28Test {
    ...
    void openConnection() throws Exception {
        connection = DriverManager.getConnection(
                "jdbc:h2:mem:scenario28;MODE=LEGACY;DB_CLOSE_DELAY=-1", "sa", "");
        try (Statement statement = connection.createStatement()) {
            statement.execute("CREATE TABLE CUSTOMER (ID INT PRIMARY KEY, NAME VARCHAR(64))");
            // Database order differs from expected order.
    ...
    @Test
    void unorderedTablesIgnoresRowOrderingBetweenExpectedAndActual() {
