 ...
 */
package org.os890.jawelte.tests.dbtestdata.scenario19;
...
class Scenario19Test {
    ...
    void openConnection() throws Exception {
        connection = DriverManager.getConnection(
                "jdbc:h2:mem:scenario19;MODE=LEGACY;DB_CLOSE_DELAY=-1", "sa", "");
        try (Statement statement = connection.createStatement()) {
            statement.execute("CREATE TABLE CUSTOMER (ID INT PRIMARY KEY, NICK VARCHAR(64))");
            statement.execute("INSERT INTO CUSTOMER VALUES (1, '~literal')");
        }
    }
