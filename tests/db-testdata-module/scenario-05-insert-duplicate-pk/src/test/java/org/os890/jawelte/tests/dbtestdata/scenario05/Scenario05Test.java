 ...
 */
package org.os890.jawelte.tests.dbtestdata.scenario05;
...
class Scenario05Test {
    ...
    void openConnection() throws Exception {
        connection = DriverManager.getConnection(
                "jdbc:h2:mem:scenario05;MODE=LEGACY;DB_CLOSE_DELAY=-1", "sa", "");
    ...
    @Test
    void insertOfExistingPrimaryKeyPropagatesAsRuntimeException() {
        String dataset = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
                + "<dataset>"
                + "<CUSTOMER ID=\"1\" NAME=\"Duplicate\"/>"
                + "</dataset>";
