 ...
 */
package org.os890.jawelte.tests.quarkus.scenario29;
...
class Scenario29Test {
    ...
    @Test
    void testBeanWithBothBeanAndBeanProducerFailsTheRunWithNotBothMessage() {
        List<Event> failures = EngineTestKit.engine("junit-jupiter")
                .selectors(selectClass(Scenario29Subject.class))
                .execute()
                .allEvents()
                .failed()
                .list();
        ...
        assertThat(rootCause(firstFailure.get())).hasMessageContaining("not both");
    }
