 ...
 */
package org.os890.jawelte.tests.quarkus.scenario28;
...
class Scenario28Test {
    ...
    @Test
    void nullStaticTestBeanFieldFailsTheRunWithIsNullMessage() {
        List<Event> failures = EngineTestKit.engine("junit-jupiter")
                .selectors(selectClass(Scenario28Subject.class))
                .execute()
                .allEvents()
                .failed()
                .list();
        ...
        assertThat(rootCause(firstFailure.get())).hasMessageContaining("is null");
    }
