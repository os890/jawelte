...
/** Equal-priority sibling of {@link TestScenarioPortZulu}; class name sorts first. */
@Priority(75)
public class TestScenarioPortAlpha implements TestModuleLifecyclePort {

    public TestScenarioPortAlpha() {
    }
