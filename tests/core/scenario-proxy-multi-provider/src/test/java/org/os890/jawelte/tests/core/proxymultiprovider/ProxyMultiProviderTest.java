...
class ProxyMultiProviderTest {

    @Test
    void multipleTestBeansExtensionImplsTriggersDocumentedIllegalStateException() {
        List<Event> failed = EngineTestKit.engine("junit-jupiter")
                .selectors(selectClass(ProxyMultiProviderSubject.class))
                .execute()
                .allEvents()
                .failed()
                .list();
        ...
        assertThat(thrown)
                ...
                .hasMessageContaining("Multiple TestBeansExtension implementations found");
    }
}
