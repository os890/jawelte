...
public class TestScenarioBeforeAllThrowingContainerPort implements TestBeanContainerPort {

    public static final AtomicBoolean AFTER_ALL_CALLED = new AtomicBoolean(false);

    public TestScenarioBeforeAllThrowingContainerPort() {
    }

    @Override
    public void beforeAll(TestContext testContext) {
        throw new IllegalStateException("beforeAll failure marker");
    }
