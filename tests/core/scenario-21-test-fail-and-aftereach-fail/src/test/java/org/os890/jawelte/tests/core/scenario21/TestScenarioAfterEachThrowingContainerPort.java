...
public class TestScenarioAfterEachThrowingContainerPort implements TestBeanContainerPort {

    public TestScenarioAfterEachThrowingContainerPort() {
    }
    ...
    public void afterEach(TestContext testContext) {
        throw new IllegalStateException("container afterEach failure marker");
    }
