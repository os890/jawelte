...
/** {@code @Transactional @ReadOnly} service that persists. */
@ApplicationScoped
public class ItemService {
    ...
    /**
     * Persist an item inside a {@code @ReadOnly} transaction.
     * The {@code ReadOnlyInterceptor} sets {@code rollback-only} on
     * the active strategy so commit becomes a rollback at JTA level.
     */
    @Transactional
    @ReadOnly
