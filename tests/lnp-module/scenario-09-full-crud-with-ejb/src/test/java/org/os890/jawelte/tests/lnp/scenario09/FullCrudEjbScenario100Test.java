...
import org.os890.jawelte.tests.lnp.scenario09.metrics.PerformanceExtension;

/**
 * Numbered copy 10000 of {@link AbstractFullCrudEjbScenarioTest}.
...
@EnableTestBeans
@PersistenceConfig(persistenceUnitName = "lnpFullCrudEjbPU")
public class FullCrudEjbScenario100Test extends AbstractFullCrudEjbScenarioTest {

    /** Default constructor for JUnit / CDI. */
    public FullCrudEjbScenario100Test() {
    }
}
