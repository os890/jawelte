...
import org.os890.jawelte.tests.lnp.scenario01.metrics.PerformanceExtension;

/**
 * Numbered copy 10000 of {@link AbstractFullCrudScenarioTest} - the
...
@EnableTestBeans
public class FullCrudScenario100Test extends AbstractFullCrudScenarioTest {

    /** Default constructor for JUnit / CDI. */
    public FullCrudScenario100Test() {
    }
}
