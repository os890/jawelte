...
import org.os890.jawelte.tests.lnp.scenario05.metrics.PerformanceExtension;

/**
 * Numbered copy 10000 of {@link AbstractFullCrudRestDbUnitScenarioTest}.
...
@EnableJaxRs(restResources = LnpRestResource.class)
@PersistenceConfig(persistenceUnitName = "lnpFullCrudRestDbUnitPU")
public class FullCrudRestDbUnitScenario100Test extends AbstractFullCrudRestDbUnitScenarioTest {

    /** Default constructor for JUnit / CDI. */
    public FullCrudRestDbUnitScenario100Test() {
    }
}
