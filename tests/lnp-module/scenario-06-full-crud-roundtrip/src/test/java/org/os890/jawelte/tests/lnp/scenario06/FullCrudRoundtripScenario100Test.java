...
import org.os890.jawelte.tests.lnp.scenario06.metrics.PerformanceExtension;

/**
 * Numbered copy 10000 of {@link AbstractFullCrudRoundtripScenarioTest}.
...
@PersistenceConfig(persistenceUnitName = "lnpFullCrudRoundtripPU")
public class FullCrudRoundtripScenario100Test extends AbstractFullCrudRoundtripScenarioTest {

    /** Default constructor for JUnit / CDI. */
    public FullCrudRoundtripScenario100Test() {
    }
}
