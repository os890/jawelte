...
import org.os890.jawelte.tests.lnp.scenario08.metrics.PerformanceExtension;

/**
 * Numbered copy 10000 of {@link AbstractFullCrudSpringDataScenarioTest}.
...
@EnableTestBeans
@PersistenceConfig(persistenceUnitName = "lnpFullCrudSpringDataPU")
public class FullCrudSpringDataScenario100Test extends AbstractFullCrudSpringDataScenarioTest {

    /** Default constructor for JUnit / CDI. */
    public FullCrudSpringDataScenario100Test() {
    }
}
