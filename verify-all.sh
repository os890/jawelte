...
if [ "$LNP_MODE" = true ]; then
    ...
    # over both CDI runtimes because the filling happens inside a
    # portable ProcessInjectionTarget wrapper and InjectionTarget
    # delegation is an area where OWB and Weld differ.
    for cdi in owb weld; do
