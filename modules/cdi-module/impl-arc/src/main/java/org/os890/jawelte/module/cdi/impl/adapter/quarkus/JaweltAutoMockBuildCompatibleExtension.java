...
public class JaweltAutoMockBuildCompatibleExtension implements BuildCompatibleExtension {
     ...
     * processing cycle.
     *
     * @param typeFqn FQN of the bean type the contributor registered
     * @param qualifierFqns FQNs of the qualifier annotations on that bean
     * @return {@code true} if {@link #preRegisterExistingBeanShape}
     *         was already called for this {@code (type, qualifiers)} pair
     */
