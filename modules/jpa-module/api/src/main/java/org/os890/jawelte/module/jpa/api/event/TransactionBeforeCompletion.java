...
/**
 * CDI event fired by jpa-module immediately before commit or
 * rollback runs on the active transaction. Observers receive the
 * persistence unit name; this is the last chance for synchronous
 * pre-completion work (audit logging, dirty-flag inspection,
